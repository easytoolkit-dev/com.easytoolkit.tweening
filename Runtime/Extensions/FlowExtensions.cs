...
namespace EasyToolkit.Fluxion.Extensions
{
    public static class FlowExtensions
    {
        ...
        /// <returns></returns>
        public static T WithUnityObject<T>(this T flow, UnityEngine.Object unityObject) where T : IFlow
        {
        ...
        /// </summary>
        public static T WithSpeedBased<T>(this T flow, bool isSpeedBased = true) where T : IFlow
        {
            flow.IsSpeedBased = isSpeedBased;
            return flow;
        }

        public static T WithLoopType<T>(this T flow, LoopType loopType) where T : IFlow
        {
