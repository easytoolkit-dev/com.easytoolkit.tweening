...
namespace EasyToolkit.Fluxion.Extensions
{
    ...
    {
        public static IFlow FluxAnchorPos(this RectTransform target, Vector2 to, float duration)
        {
        ...
        public static IFlow FluxAnchorPosX(this RectTransform target, float to, float duration)
        {
        ...
        public static IFlow FluxAnchorPosY(this RectTransform target, float to, float duration)
        {
        ...
        public static IFlow FluxFade(this CanvasGroup target, float to, float duration)
        {
            return FluxFactory.To(() => target.alpha, val => target.alpha = val, to, duration)
                .WithUnityObject(target);
        }

        public static IFlow FluxMaxVisibleCharacters(this TextMeshProUGUI target, int to, float duration)
        {
            return FluxFactory.To(() => target.maxVisibleCharacters, val => target.maxVisibleCharacters = val, to, duration)
                .WithUnityObject(target);
        }

        public static IFlow FluxSpritesAnim(this Image target, Sprite[] sprites, float duration)
        {
